        ...
        {zones.map((zone) => (
          <Pressable key={zone.id} style={[styles.zoneCard, { backgroundColor: theme.card }]} onPress={() => onSelectZone(zone)}>
            <View style={styles.zoneHeader}>
              ...
              <View style={[styles.badge, { backgroundColor: zone.isActive ? RabbitFoodColors.success + "20" : "#ccc" }]}>
                <Text style={{ color: zone.isActive ? RabbitFoodColors.success : "#666", fontSize: 12 }}>
